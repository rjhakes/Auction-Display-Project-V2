...
export default class Themer {
  ...
  themeSettings = (mode: any) => {
    const colors = this.tokens(mode);
    return {
      palette: {
        mode: mode,
        ...(mode === "dark"
  ...
  useMode = () => {
    ...
    const theme = useMemo(() => createTheme({
      palette: {
        ...
        ? {
        primary: {
          light: Color.PRIMARY100, 
          main: Color.PRIMARY200,
          dark: Color.PRIMARY300,
          contrastText: Color.PRIMARY500,
        },
        secondary: {
          light: Color.GREEN300, 
          main: Color.GREEN500,
          dark: Color.GREEN600,
          contrastText: Color.GREEN100,
        },
        background: {
