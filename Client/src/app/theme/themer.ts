...
export default class Themer {
  ...
  //       () => ({
  //         toggleColorMode: () =>
  //           this.setMode((prev: string) => (prev === "light" ? "dark" : "light")),
  //       }),
  //       []
  //     );
    
  //     // const theme = useMemo(() => createTheme(themeSettings(mode)), [mode]);
  //     // const theme: React.FC<ThemeProps> = ({theme}) => useMemo(() => createTheme(themeSettings(mode)), [mode]);
...
// export const ColorModeContext = createContext<ThemeContextProps | Theme>({
//   toggleColorMode: () => {},
// });
